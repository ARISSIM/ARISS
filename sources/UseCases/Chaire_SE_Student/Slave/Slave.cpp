...
void* f_thread_F(void *args) {
    ...
    arg->manager_sat->gerer_mission("SLAVE", arg->mode_fonctionnement, arg->horloge_sat, arg->analyseur_sat, arg->scao_sat, arg->camera_sat,
...
int main(int argc, char *argv[]) {
    ...
    pid_partition = GUI_ARINC_partition("Slave", position, redemarrage);
